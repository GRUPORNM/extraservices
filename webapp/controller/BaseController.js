sap.ui.define([
    ...
    return Controller.extend("extraservices.controller.BaseController", {
        ...
        setModelTQA: function (token) {
            ...
            TQAModel = new sap.ui.model.odata.v2.ODataModel({
                ...
                annotationURI: "/zsrv_iwfnd/Annotations(TechnicalName='%2FTQA%2FOD_EXTRA_SERVICES_ANNO_MDL',Version='0001')/$value/",
                headers: {
                    "authorization": token,
                    "applicationName": "SERVICES_MANAGE"
                }
            });
        ...
        onNavBack: function () {
            ...
            if (this.byId("createServicePage").getParent().getBindingContext()) {
                var aButtons = [],
                    oConfirmButton = {
                        id: "ConfirmButton",
                        visible: false
        ...
        showError: function(textKey, titleKey) {
            new sap.m.MessageBox.error(this.getResourceBundle().getText(textKey), {
                title: this.getResourceBundle().getText(titleKey),
                actions: [sap.m.MessageBox.Action.OK],
                emphasizedAction: sap.m.MessageBox.Action.OK
            });
        },
        
        showWarning: function(textKey, titleKey) {
            new sap.m.MessageBox.warning(this.getResourceBundle().getText(textKey), {
                title: this.getResourceBundle().getText(titleKey),
                actions: [sap.m.MessageBox.Action.OK],
                emphasizedAction: sap.m.MessageBox.Action.OK
            });
            ...
            try {
                if (sPath) {
                    var oModel = this.getModel(),
                        oAppViewModel = this.getModel("appView"),
                        oMessage = {
                            oText: "serviceUpdateText",
                            oTitle: "serviceUpdateTitle"
                        };
